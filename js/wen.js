(function() {
    // 要操作的元素
    const lis = document.querySelectorAll('.wen-container .wen-item'),
          ps = document.querySelectorAll('.wen-container .wen-item p');
    ...
    function mouseEvent(angle, o, d) {
        const w = o.offsetWidth,
              h = o.offsetHeight;
        const p = o.querySelector('p');     //元素下的p元素
